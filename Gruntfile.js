...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        // Replace version tag by actual version
        replace: {
            version_replace: {
                options: {
                    variables: {
    ...
    grunt.registerTask('deploy', 'Deploy to parse.', function () {
        // read the app version from the bower file
        var appBower = grunt.file.readJSON('bower.json');
