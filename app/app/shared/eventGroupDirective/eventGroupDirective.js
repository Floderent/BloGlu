...
angular.module('bloglu.eventGroupDirective').directive('blogluEventGroup', ['$compile', '$injector', '$q','eventService','unitService', function ($compile, $injector, $q, eventService, unitService) {
