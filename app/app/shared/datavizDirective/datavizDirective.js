...
angular.module('bloglu.datavizDirective').directive('dataviz', function ($compile) {
...
angular.module('bloglu.datavizDirective').directive('tableDataviz', ['$q', '$translate', 'dataService', function ($q, $translate, dataService) {
        var linkFunction = function (scope, element, attrs) {
...
angular.module('bloglu.datavizDirective').directive('chartDataviz', ['$compile', '$q', '$translate', 'dataService', function ($compile, $q, $translate, dataService) {
        var linkFunction = function (scope, element, attrs) {
