(function () {
    ...
    importListController.$inject = ['$scope', '$rootScope', 'importService', 'MessageService', 'Utils'];

    function importListController($scope, $rootScope, importService, MessageService, Utils) {
